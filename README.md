...
![沐雪blog主页](https://github.com/lisbeth0720/lisbeth0720.github.io/blob/master/img/blog.png)
...
friends: [
    {
        title: "Lisbeth Blog",
        href: "https://lisbeth0720.github.io/"
    },
    {
        title: "Apple",
...
ga_domain: 2015cewangxueqin.club			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
我的博客标题是 **“Lisbeth Blog”** 但是我想要在搜索的时候显示 **“沐雪的博客”** ，这个就需要 SEO Title 来定义了。
...
遵循 MIT 许可证。有关详细,请参阅 [LICENSE](https://github.com/lisbeth0720/lisbeth0720.github.io/blob/master/LICENSE)。
